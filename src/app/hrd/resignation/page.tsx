...
const currentUserId = "hrd-01";

export default function HrdResignationPage() {
    ...
    function onSubmit(data: ResignationFormValues) {
        ...
        const newRequest: ResignationRequest = {
            ...
            reason: data.reason,
            status: "Menunggu Persetujuan Owner", // HRD requests go directly to Owner
        };
        ...
        setTimeout(() => {
            toast({
                ...
                description: "Permintaan Anda telah diterima dan diteruskan ke Owner.",
            });
            form.reset();
