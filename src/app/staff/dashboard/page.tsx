...
export default function StaffDashboardPage() {
    ...
    const kpiData = db.kpiHistory.filter(kpi => kpi.employeeId === currentUserId).sort((a,b) => a.quarter.localeCompare(b.quarter));
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                ...
                <Card>
                    <CardHeader>
                        <div className="flex items-center gap-3">
                            ...
                            <CardTitle className="font-headline">KPI Kuartalan Pribadi</CardTitle>
                        </div>
                ...
                <Card>
                    <CardHeader>
                       <div className="flex items-center gap-3">
                            ...
                            <CardTitle className="font-headline">Riwayat Pengajuan Cuti</CardTitle>
                        </div>
                        <CardDescription>Daftar pengajuan cuti Anda yang terbaru.</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <Table>
                            <TableHeader>
                            ...
                            <TableBody>
                                {leaveHistory.slice(0, 4).map((leave) => (
                                    <TableRow key={leave.id}>
                                        ...
                                        <TableCell>{`${format(leave.dates.from, "dd/MM/yy", {locale:id})} - ${format(leave.dates.to, "dd/MM/yy", {locale:id})}`}</TableCell>
            ...
            <div className="space-y-8">
                ...
                <Card className="text-center">
                    <CardHeader>
                        <CardTitle className="font-headline">Sisa Cuti Tahunan</CardTitle>
                    </CardHeader>
                    <CardContent>
                ...
                <Card>
                    <CardHeader>
                        <div className="flex items-center gap-3">
                            ...
                            <CardTitle className="font-headline">Info & Pengumuman</CardTitle>
                        </div>
                    </CardHeader>
                    <CardContent>
